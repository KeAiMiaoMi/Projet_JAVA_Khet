...
public class Piece {
	...
	public int color, orientation;
	public Piece hittingP;
	
	public Piece(int color, int col, int row, int orientation) {
		this.color = color;
		this.col = col;
		this.row = row;
	...
	public GamePanel getParentPanel() {
    	return (GamePanel) this.getParentPanel();
	}
	...
	// Rotation des pièces
	public void rotate(boolean isRightTurn) {
        if (isRightTurn) {
